...
#include "GALAGA_USFX_LAB03/Subscriptor1.h"
#ifdef _MSC_VER
#pragma warning (push)
#pragma warning (disable : 4883)
#endif
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeSubscriptor1() {}
// Cross Module References
	GALAGA_USFX_LAB03_API UClass* Z_Construct_UClass_ASubscriptor1_NoRegister();
	GALAGA_USFX_LAB03_API UClass* Z_Construct_UClass_ASubscriptor1();
...
// End Cross Module References
	void ASubscriptor1::StaticRegisterNativesASubscriptor1()
	{
	}
	UClass* Z_Construct_UClass_ASubscriptor1_NoRegister()
	{
		return ASubscriptor1::StaticClass();
	}
	struct Z_Construct_UClass_ASubscriptor1_Statics
	{
	...
	UObject* (*const Z_Construct_UClass_ASubscriptor1_Statics::DependentSingletons[])() = {
		(UObject* (*)())Z_Construct_UClass_AActor,
		(UObject* (*)())Z_Construct_UPackage__Script_GALAGA_USFX_LAB03,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ASubscriptor1_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "Subscriptor1.h" },
		{ "ModuleRelativePath", "Subscriptor1.h" },
	};
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ASubscriptor1_Statics::NewProp_MallaSub1_MetaData[] = {
		{ "Category", "Malla" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Subscriptor1.h" },
	};
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ASubscriptor1_Statics::NewProp_EscudoNave = { "EscudoNave", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ASubscriptor1, EscudoNave), Z_Construct_UClass_ANaveEscudo_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ASubscriptor1_Statics::NewProp_EscudoNave_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ASubscriptor1_Statics::NewProp_EscudoNave_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ASubscriptor1_Statics::PropPointers[] = {
		...
		const UE4CodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_ASubscriptor1_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UISubscriptor_NoRegister, (int32)VTABLE_OFFSET(ASubscriptor1, IISubscriptor), false },
			{ Z_Construct_UClass_UITransformar_NoRegister, (int32)VTABLE_OFFSET(ASubscriptor1, IITransformar), false },
		};
	const FCppClassTypeInfoStatic Z_Construct_UClass_ASubscriptor1_Statics::StaticCppClassTypeInfo = {
		TCppClassTypeTraits<ASubscriptor1>::IsAbstract,
	};
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_ASubscriptor1_Statics::ClassParams = {
		&ASubscriptor1::StaticClass,
		"Engine",
		&StaticCppClassTypeInfo,
		DependentSingletons,
		nullptr,
		Z_Construct_UClass_ASubscriptor1_Statics::PropPointers,
		InterfaceParams,
		UE_ARRAY_COUNT(DependentSingletons),
		0,
		UE_ARRAY_COUNT(Z_Construct_UClass_ASubscriptor1_Statics::PropPointers),
		UE_ARRAY_COUNT(InterfaceParams),
		0x009000A4u,
		METADATA_PARAMS(Z_Construct_UClass_ASubscriptor1_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_ASubscriptor1_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_ASubscriptor1()
	{
		static UClass* OuterClass = nullptr;
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_ASubscriptor1_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(ASubscriptor1, 427313426);
	template<> GALAGA_USFX_LAB03_API UClass* StaticClass<ASubscriptor1>()
	{
		return ASubscriptor1::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ASubscriptor1(Z_Construct_UClass_ASubscriptor1, &ASubscriptor1::StaticClass, TEXT("/Script/GALAGA_USFX_LAB03"), TEXT("ASubscriptor1"), false, nullptr, nullptr, nullptr);
	DEFINE_VTABLE_PTR_HELPER_CTOR(ASubscriptor1);
